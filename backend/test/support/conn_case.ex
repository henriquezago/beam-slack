defmodule BeamSlackWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use BeamSlackWeb.ConnCase, async: true`, although
  ...
  using do
    quote do
      ...
      use BeamSlackWeb, :verified_routes

      # Import conveniences for testing with connections
      import Plug.Conn
      import Phoenix.ConnTest
      import BeamSlackWeb.ConnCase
    end
  end
